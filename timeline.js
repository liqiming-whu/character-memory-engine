      ...
      timelineItems.push({
        ...
        render: UI.Surface({ fillMaxWidth: true, shape: { cornerRadius: 8 }, containerColor: getTypeColor(e.type), alpha: 0.08, padding: 8 }, [
          UI.Row({ fillMaxWidth: true, verticalAlignment: 'center' }, [
            ...
            makeDeleteBtn('events', (e.id !== undefined ? e.id : allEvents.indexOf(e)), 'events:' + (e.id !== undefined ? e.id : allEvents.indexOf(e))),
          ].filter(Boolean)),
        ])
      });
      ...
      timelineItems.push({
        ...
        render: UI.Surface({ fillMaxWidth: true, shape: { cornerRadius: 8 }, containerColor: amtColor, alpha: 0.08, padding: 8 }, [
          UI.Row({ fillMaxWidth: true, verticalAlignment: 'center' }, [
            ...
            makeDeleteBtn('finance', (f.id !== undefined ? f.id : allFinance.indexOf(f)), 'finance:' + (f.id !== undefined ? f.id : allFinance.indexOf(f))),
          ]),
        ])
      });
      ...
      timelineItems.push({
        ...
        render: UI.Surface({ fillMaxWidth: true, shape: { cornerRadius: 8 }, containerColor: colors.tertiaryContainer, padding: 8 }, [
          UI.Row({ fillMaxWidth: true, verticalAlignment: 'center' }, [
            ...
            makeDeleteBtn('menstrual', (m.id !== undefined ? m.id : allMenstrual.indexOf(m)), 'menstrual:' + (m.id !== undefined ? m.id : allMenstrual.indexOf(m))),
          ].filter(Boolean)),
        ])
      });
